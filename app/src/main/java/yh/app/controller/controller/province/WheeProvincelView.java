...
package yh.app.controller.controller.province;
 ...
 */
public class WheeProvincelView extends View {
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
	 ...
	 * Constructor
	 */
	public WheeProvincelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheeProvincelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheeProvincelView(Context context) {
		super(context);
		initData(context);
	}
