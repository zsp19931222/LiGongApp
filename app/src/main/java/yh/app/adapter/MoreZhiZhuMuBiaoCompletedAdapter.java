 ...
 * @date 2017年4月28日
 */
public class MoreZhiZhuMuBiaoCompletedAdapter extends BaseAdapter {
	private Context context;
	private List<MoreZhiZhuMuBiaoModel.ContentBean.MessageBean.CompletedBean> list;
	private LayoutInflater inflater;

	public MoreZhiZhuMuBiaoCompletedAdapter(Context context,
			List<MoreZhiZhuMuBiaoModel.ContentBean.MessageBean.CompletedBean> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.txt_riwu.setTextColor(context.getResources().getColor(R.color.color_light_gray));
		viewHolder.txt_zhuangtai.setTextColor(context.getResources().getColor(R.color.color_light_gray));
