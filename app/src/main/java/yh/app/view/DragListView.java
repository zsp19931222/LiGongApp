...
public class DragListView extends ListView implements OnScrollListener, OnClickListener
{
	...
	public void initHeadView(Context context)
	{
		...
		mHeadView = LayoutInflater.from(context).inflate(R.layout.wxjz_head, (ViewGroup) ((Activity) context).findViewById(R.id.layout), false);
	...
	{
		// mFootView = LayoutInflater.from(context).inflate(R.layout.footer,
		// null);
		//
		...
		//
		// mLoadingView = (LinearLayout)
		// mFootView.findViewById(R.id.loading_layout);
		//
