...
public class DragPointView extends TextView {
    ...
    public DragPointView(Context context) {
        ...
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s == null || s.toString().isEmpty() || s.toString().equals("0")) {
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        super.setBackground(createStateListDrawable((getHeight() > getWidth() ? getHeight() : getWidth()) / 2, backgroundColor));
    }
...
//	}
    ...
    public interface PointViewDragLisitener {
        public void broken(DragPointView dragPointView);

        public void cancel(DragPointView dragPointView);
    }
