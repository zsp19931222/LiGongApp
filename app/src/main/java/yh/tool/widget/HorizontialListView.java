...
public class HorizontialListView extends AdapterView<ListAdapter> {
	...
	public HorizontialListView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private synchronized void initView() {
		...
		mGesture = new GestureDetector(getContext(), (android.view.GestureDetector.OnGestureListener) mOnGesture);
	}
