package com.example.app3.severs;
...
public class DownLoadService extends Service {
    ...
    private String url;
    private String DOWNLOADPATH = "/ydxy/apk/";
    ...
    private void initDownManager() {
        ...
        down.setDestinationInExternalPublicDir(DOWNLOADPATH,"ydxy.apk");
        down.setTitle("移动校园");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath()+ DOWNLOADPATH + "ydxy.apk";
