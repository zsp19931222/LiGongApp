...
public class SearchFriendActivity extends BaseRecyclerViewActivity {
    ...
    private List<Map<String, String>> data;//数据源（数据库数据）
    ...
    protected void init(Context context) {
        data = new SqliteHelper().rawQuery("select * from friend");
