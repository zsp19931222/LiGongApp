...
public class PushBrowserActivity extends ActivityPortrait implements OnClickListener {
    /**
    ...
    private void init() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("map:")) {
                    ...
                    helper.scanQRCode(PushBrowserActivity.this);
                    return true;
                } else {
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onReceivedTitle(WebView webView, String s) {
                ...
                myTitleView.setTitle(s, PushBrowserActivity.this);
            }
...
//        });
        ...
        mMore.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(PushBrowserActivity.this, "not completed",
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case PHOTO_REQUEST:
                    ...
                    break;
                case PHOTO_CLIP:
                    if (null != mUploadMsgFive) {
                        mUploadMsgFive.onReceiveValue(mFileChooserParams.parseResult(resultCode, data));
                        mUploadMsgFive = null;
                        setWindowDismiss();
                    }
                    if (null != uploadFile) {
...
//
    ...
    protected void onPause() {
        super.onPause();
        try {
            if (ActivityUtil.getActivityList(this) != null && ActivityUtil.getActivityList(this).size() > 0) {
                ComponentName cpn = ActivityUtil.getActivityList(this).get(0).topActivity;
                if (!"com.example.app4.activity.MainActivity".equals(cpn.getClassName())&&!"com.example.app3.activity.AllMessageList".equals(cpn.getClassName())) {
    ...
    public Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                new DownloadPopupWindow(PushBrowserActivity.this, map.get("name") + "", map.get("url") + "", (int) map.get("size")).show(mWebView);
            } else {
                Toast.makeText(PushBrowserActivity.this, "下载失败", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void getCamera() {
        new RxPermissions(PushBrowserActivity.this).
    ...
    Observer observer = new Observer<Boolean>() {
        ...
        public void onError(Throwable e) {
            Toast.makeText(PushBrowserActivity.this, "相机权限打开失败", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onNext(Boolean o) {
            if (o) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    Uri imageUri = FileProvider.getUriForFile(PushBrowserActivity.this, PushBrowserActivity.this.getApplicationContext().getPackageName() + ".provider", new File(Environment.getExternalStorageDirectory(), "hand.jpg"));
                ...
                PushBrowserActivity.this.startActivityForResult(intent, CAMERA_REQUEST);
            } else {
                Toast.makeText(PushBrowserActivity.this, "相机权限打开失败", Toast.LENGTH_SHORT).show();
            }
        }
