...
public class TeacherCallRecordActivity extends com.example.smartclass.base.BaseRecyclerViewActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_call_detail_record_teacher;
    }
    ...
    protected void init(Context context) {
        ...
        cdSubmitText.setVisibility(View.GONE);
        cdStartText.setVisibility(View.GONE);
        cdTitle.setTitle("点名记录", this);
    }
                ...
                if (JSONTool.Code(result).equals(JSONTool.SUCCESS)) {//访问成功
                    ...
                    switch (callStateResult) {
                        case BeanState.DM_State.WDM://未点名
                            isSignFirst = true;
                            cdStartText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.white));
                            cdStartText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_3df4ff));
                            cdSubmitText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.color_gray_999999));
                            cdSubmitText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_f5f5f5));
                            break;
                        case BeanState.DM_State.YDM://已点名
                            isSignFirst = false;
                            cdStartText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.color_gray_999999));
                            cdStartText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_f5f5f5));
                            cdSubmitText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.color_gray_999999));
                            cdSubmitText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_f5f5f5));
                            break;
                        case BeanState.DM_State.ZZDM://正在点名
                            ...
                            cdStartText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.color_gray_999999));
                            cdStartText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_f5f5f5));
                            cdSubmitText.setTextColor(ContextCompat.getColor(TeacherCallRecordActivity.this, R.color.white));
                            cdSubmitText.setBackground(ContextCompat.getDrawable(TeacherCallRecordActivity.this, R.drawable.gradient_3df4ff));
                            break;
                    }
        ...
        switch (event.getTag()) {
            ...
            case TagUtil.GetCodeTag://获取验证码
                if (result.equals(HintTool.REQUESTFAIL)) {
                    ...
                    Intent intent = new Intent(TeacherCallRecordActivity.this, VerificationCodeActivity.class);
