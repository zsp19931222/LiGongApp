...
public class ForgetPasswordVerificationCodeActivity extends BaseRecyclerViewActivity {
    ...
    public ForgetPasswordVerificationCodeActivity() {
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.binding_next_btn:
                if (canClick) {
                    ...
                    new ForgetPasswordPresenter(this).verificationCode(VerificationCodeNum, phoneNum);
                }
                break;
            case R.id.binding_countdown_text:
                if (bindingCountdownText.getText().toString().equals("重新获取")) {
                    ...
                    showLoad("");
                    bindingJudgeText.setText("");
                    new ForgetPasswordPresenter(this).forgetPasswordGetCode(phoneNum);
                }
                break;
        }
    }
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (s.toString().length() == 7) {
                ...
                bindingJudgeText.setTextColor(ContextCompat.getColor(ForgetPasswordVerificationCodeActivity.this, R.color.color_blue_3da8f5));
                bindingNextBtn.setBackground(ContextCompat.getDrawable(ForgetPasswordVerificationCodeActivity.this, R.drawable.border_shade_3da8f5));
                canClick = true;
            } else {
                bindingJudgeText.setVisibility(View.GONE);
                bindingNextBtn.setBackground(ContextCompat.getDrawable(ForgetPasswordVerificationCodeActivity.this, R.drawable.border_shade_e5e9ee));
            }
    ...
    private CountDownTimer countDownTimer = new CountDownTimer(60 * 1000, 1000) {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            bindingCountdownText.setBackground(ContextCompat.getDrawable(ForgetPasswordVerificationCodeActivity.this, R.drawable.border_radius_d5d5d5));
        }

        @Override
        public void onFinish() {
            bindingCountdownText.setText("重新获取");
            bindingCountdownText.setBackground(ContextCompat.getDrawable(ForgetPasswordVerificationCodeActivity.this, R.drawable.border_radius_3da8f5_45px));
        }
    };
    ...
    public void onEventMainThread(MessageEvent event) {
        ...
        if (ActivityUtil.isForeground(this))
            switch (event.getTag()) {
                case TagUtil.forgetPasswordVerificationCodeTag:
                    ...
                    intent = new Intent(this, ForgetPasswordNewPasswordActivity.class);
